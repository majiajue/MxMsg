...
public class Login extends JFrame {
		...
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					Shape shape = null;
					shape = new RoundRectangle2D.Double(0, 0, frame.getWidth(),
							frame.getHeight(), 10D, 10D);
	...
	public Login() {
		...
		contentPane.setBackground(new Color(223, 227, 225));
		contentPane.setLayout(null);
		contentPane.setOpaque(true);
		pwd密码 = new JPasswordField();
		pwd密码.setText("123");
		pwd密码.setEchoChar('●');
		pwd密码.setBounds(90, 163, 260, 50);
		contentPane.add(pwd密码);

		lblQQ2013 = new JLabel("密讯");
		lblQQ2013.setBackground(new Color(75, 136, 191));
		lblQQ2013.setForeground(Color.WHITE);
		lblQQ2013.setHorizontalAlignment(SwingConstants.CENTER);
		lblQQ2013.setVerticalAlignment(SwingConstants.CENTER);
		lblQQ2013.setFont(new Font("微软雅黑", Font.PLAIN, 30));
		lblQQ2013.setOpaque(true);
		lblQQ2013.setBounds(0, 0, 410, 50);
		...
		// lbl登录 = new JLabel("");
		// lbl登录.setIcon(new
		// ImageIcon(Login.class.getResource("/com/mx/client/image/button/button_login_1.png")));
		// lbl登录.setBounds(49, 237, 410, 50);
		...
		button.setBounds(40, 237, 310, 50);
		button.setBorder(null);
		button.setBackground(new Color(75, 136, 191));
				...
				try {
					...
					if (userId.trim() != null && password.trim().length()!=0) {
						if (loginProcess(userId, password)) {
							...
							JOptionPane.showMessageDialog(null, "你输入的用户名密码错误!");
							
						}
					
					} else {
						JOptionPane.showMessageDialog(null, "请输入用户名或者密码!");
		...
		textField用户名.setBounds(90, 91, 260, 50);
		...
		// lbl最小化 = new JLabel("");
		// lbl最小化.setIcon(new
		// ImageIcon(Login.class.getResource("/com/mx/client/image/button/login_minsize_1.png")));
		...
		// lbl退出 = new JLabel("");
		// lbl退出.setIcon(new
		// ImageIcon(Login.class.getResource("/com/mx/client/image/button/login_exit_1.png")));
		...
		// lbl多账号 = new JLabel("");
		// lbl多账号.setIcon(new
		// ImageIcon(Login.class.getResource("/com/mx/client/image/button/login_duozhanghao_1.png")));
		// lbl多账号.setBounds(14, 237, 69, 21);
		// contentPane.add(lbl多账号);
		//
		// lbl设置 = new JLabel("");
		// lbl设置.setIcon(new
		// ImageIcon(Login.class.getResource("/com/mx/client/image/button/login_setting_1.png")));
	 ...
	 * @throws IOException
	 */
	private boolean loginProcess(String userId, String password)
			throws IOException {
